...
!function webpackUniversalModuleDefinition(root, factory) {
        ...
        Inputmask.prototype = {
            ...
            unmaskedvalue: function unmaskedvalue(value) {
                ...
                void 0 === this.el || void 0 !== value) {
                    ...
                    $.isFunction(this.opts.onBeforeWrite) && this.opts.onBeforeWrite.call(this, void 0, _positioning.getBuffer.call(this), 0, this.opts)
                }
    ...
    , function(module, exports, __webpack_require__) {
        ...
        function caret(input, begin, end, notranslate, isDelete) {
            ...
            if ($.isArray(begin) && (end = this.isRTL ? begin[0] : begin[1],
            ...
            selectedCaret.begin === selectedCaret.end) {
                ...
                default:
                    ...
                    if (clickPosition < lastPosition)
                        selectedCaret.end = selectedCaret.begin = isMask.call(inputmask, clickPosition, !0) || isMask.call(inputmask, clickPosition - 1, !0) ? clickPosition : seekNext.call(inputmask, clickPosition);
                    else {
                    ...
                    (!strict || !0 === fromIsValid) && !1 === result && !0 !== validateOnly) {
                        ...
                        if (!currentPosValid || !0 !== currentPosValid.match.static || currentPosValid.match.def !== c && c !== opts.skipOptionalPartCharacter) {
                            if (opts.insertMode || void 0 === maskset.validPositions[_positioning.seekNext.call(inputmask, maskPos)] || pos.end > maskPos) {
                                ...
                                !skip && !_positioning.isMask.call(inputmask, maskPos, opts.keepStatic))
        ...
        var EventHandlers = {
            keydownEvent: function keydownEvent(e) {
                ...
                if (k === _keycode.default.BACKSPACE || k === _keycode.default.DELETE || _environment.iphone && k === _keycode.default.BACKSPACE_SAFARI || e.ctrlKey && k === _keycode.default.X && !("oncut"in input))
                    ...
                    $input.trigger("click")) : !0 === opts.tabThrough && k === _keycode.default.TAB ? (!0 === e.shiftKey ? (!0 === _validationTests.getTest.call(inputmask, pos.begin).match.static && (pos.begin = _positioning.seekNext.call(inputmask, pos.begin)),
                    pos.end = _positioning.seekPrevious.call(inputmask, pos.begin, !0),
                    pos.begin = _positioning.seekPrevious.call(inputmask, pos.end, !0)) : (pos.begin = _positioning.seekNext.call(inputmask, pos.begin, !0),
    ...
    , function(module, exports, __webpack_require__) {
        ...
        im.dependencyLib === jQuery && __webpack_require__(21),
        module.exports = im
    }
    ],
    installedModules = {},
